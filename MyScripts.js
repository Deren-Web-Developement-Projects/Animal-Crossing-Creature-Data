...
var fishNorth = [
    ...
    ["Char","River (Clifftop)",3800,3,6,1600,900],
    ["Char","River (Clifftop)",3800,9,11,1600,900],
...
var fishSouth = [
    ...
    ["Char","River (Clifftop)",3800,3,5,1600,900],
    ["Char","River (Clifftop)",3800,9,12,1600,900],
...
function north() {
    ...
    for (var i = 1; i < fishNorth.length; i++) {
        if (fishNorth[i][3] == currentMonth) {
            ...
            cell1.innerHTML = "<img src='images/Fish/" + fishNorth[i][0] + ".png' alt='" + fishNorth[i][0] + "'/>";
            cell2.innerHTML = fishNorth[i][0];
            cell3.innerHTML = fishNorth[i][1];
            cell5.innerHTML = fishNorth[i][2];

            //Display the time range
            var timeOutput;
            var startVal, endVal;
            var startTime, endTime;
            if ((fishNorth[i][5] == "0") && fishNorth[i][6] == "2359") {
                timeOutput = "All Day";
            } else {
                startVal = fishNorth[i][5].toString();
                endVal = fishNorth[i][6].toString();
                if (startVal.length == 3) {
                    startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
                } else {
                    startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
                }
                if (endVal.length == 3) {
                    endTime = endVal.charAt(0) + ":" + endVal.charAt(1) + endVal.charAt(2);
                } else {
                    endTime = endVal.charAt(0) + endVal.charAt(1) + ":" + endVal.charAt(2) + endVal.charAt(3);
                }
                timeOutput = startTime + " - " + endTime;
            }
            cell4.innerHTML = timeOutput;

            //Apply the classes
            cell1.className = "tableValues";
            cell2.className = "tableValues";
            cell3.className = "tableValues";
            cell4.className = "tableValues";
            cell5.className = "tableValues";
        }
    }
    /* -------------------- NEW FISH -------------------- */
    /* -------------------- OLD FISH -------------------- */
    ...
    for (var i = 1; i < bugsNorth.length; i++) {
        if (bugsNorth[i][3] == currentMonth) {
            ...
            var cell4 = newRow.insertCell(3);
            var cell5 = newRow.insertCell(4);
            cell1.innerHTML = "<img src='images/Bugs/" + bugsNorth[i][0] + ".png' alt='" + bugsNorth[i][0] + "'/>";
            cell2.innerHTML = bugsNorth[i][0];
            cell3.innerHTML = bugsNorth[i][1];
            cell5.innerHTML = bugsNorth[i][2];

            //Display the time range
            var timeOutput;
            var startVal, endVal;
            var startTime, endTime;
            if ((bugsNorth[i][5] == "0") && bugsNorth[i][6] == "2359") {
                timeOutput = "All Day";
            } else {
                startVal = bugsNorth[i][5].toString();
                endVal = bugsNorth[i][6].toString();
                if (startVal.length == 3) {
                    startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
                } else {
                    startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
    ...
    for (var i = 1; i < creaturesNorth.length; i++) {
        if (creaturesNorth[i][3] == currentMonth) {
            ...
            var cell4 = newRow.insertCell(3);
            var cell5 = newRow.insertCell(4);
            cell1.innerHTML = "<img src='images/Creatures/" + creaturesNorth[i][0] + ".png' alt='" + creaturesNorth[i][0] + "'/>";
            cell2.innerHTML = creaturesNorth[i][0];
            cell3.innerHTML = creaturesNorth[i][1];
            cell5.innerHTML = creaturesNorth[i][2];

            //Display the time range
            var timeOutput;
            var startVal, endVal;
            var startTime, endTime;
            if ((creaturesNorth[i][5] == "0") && creaturesNorth[i][6] == "2359") {
                timeOutput = "All Day";
            } else {
                startVal = creaturesNorth[i][5].toString();
                endVal = creaturesNorth[i][6].toString();
                if (startVal.length == 3) {
                    startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
                } else {
                    startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
...
for (var i = 1; i < fishSouth.length; i++) {
    if (fishSouth[i][3] == currentMonth) {
        ...
        var cell4 = newRow.insertCell(3);
        var cell5 = newRow.insertCell(4);
        cell1.innerHTML = "<img src='images/Fish/" + fishSouth[i][0] + ".png' alt='" + fishSouth[i][0] + "'/>";
        cell2.innerHTML = fishSouth[i][0];
        cell3.innerHTML = fishSouth[i][1];
        cell5.innerHTML = fishSouth[i][2];

        //Display the time range
        var timeOutput;
        var startVal, endVal;
        var startTime, endTime;
        if ((fishSouth[i][5] == "0") && fishSouth[i][6] == "2359") {
            timeOutput = "All Day";
        } else {
            startVal = fishSouth[i][5].toString();
            endVal = fishSouth[i][6].toString();
            if (startVal.length == 3) {
                startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
            } else {
                startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
...
for (var i = 1; i < bugsSouth.length; i++) {
    if (bugsSouth[i][3] == currentMonth) {
        ...
        var cell4 = newRow.insertCell(3);
        var cell5 = newRow.insertCell(4);
        cell1.innerHTML = "<img src='images/Bugs/" + bugsNorth[i][0] + ".png' alt='" + bugsSouth[i][0] + "'/>";
        cell2.innerHTML = bugsSouth[i][0];
        cell3.innerHTML = bugsSouth[i][1];
        cell5.innerHTML = bugsSouth[i][2];

        //Display the time range
        var timeOutput;
        var startVal, endVal;
        var startTime, endTime;
        if ((bugsSouth[i][5] == "0") && bugsSouth[i][6] == "2359") {
            timeOutput = "All Day";
        } else {
            startVal = bugsSouth[i][5].toString();
            endVal = bugsSouth[i][6].toString();
            if (startVal.length == 3) {
                startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
            } else {
                startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
...
for (var i = 1; i < bugsSouth.length; i++) {
    if (bugsSouth[i][4] == currentMonth) {
        ...
        var cell4 = newRow.insertCell(3);
        var cell5 = newRow.insertCell(4);
        cell1.innerHTML = "<img src='images/Bugs/" + bugsSouth[i][0] + ".png' alt='" + bugsSouth[i][0] + "'/>";
        cell2.innerHTML = bugsSouth[i][0];
        cell3.innerHTML = bugsSouth[i][1];
        cell5.innerHTML = bugsSouth[i][2];
...
for (var i = 1; i < creaturesSouth.length; i++) {
    if (creaturesSouth[i][3] == currentMonth) {
        ...
        var cell4 = newRow.insertCell(3);
        var cell5 = newRow.insertCell(4);
        cell1.innerHTML = "<img src='images/Creatures/" + creaturesSouth[i][0] + ".png' alt='" + creaturesSouth[i][0] + "'/>";
        cell2.innerHTML = creaturesSouth[i][0];
        cell3.innerHTML = creaturesSouth[i][1];
        cell5.innerHTML = creaturesSouth[i][2];

        //Display the time range
        var timeOutput;
        var startVal, endVal;
        var startTime, endTime;
        if ((creaturesSouth[i][5] == "0") && creaturesSouth[i][6] == "2359") {
            timeOutput = "All Day";
        } else {
            startVal = creaturesSouth[i][5].toString();
            endVal = creaturesSouth[i][6].toString();
            if (startVal.length == 3) {
                startTime = startVal.charAt(0) + ":" + startVal.charAt(1) + startVal.charAt(2);
            } else {
                startTime = startVal.charAt(0) + startVal.charAt(1) + ":" + startVal.charAt(2) + startVal.charAt(3);
